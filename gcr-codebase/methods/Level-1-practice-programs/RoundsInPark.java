...
public class RoundsInPark{
	...
	public static void main(String[] args){
		...
		System.out.print("Enter the length of a side 1 of traingular park in meter : ");
		double side1 = sc.nextDouble();
		
		System.out.print("Enter the length of a side 2 of traingular park in meter : ");
		double side2 = sc.nextDouble();
		
		System.out.print("Enter the length of a side 3 of traingular park in meter : ");
